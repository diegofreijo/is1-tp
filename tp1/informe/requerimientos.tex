...
\item \negrita{El sistema permite la configuraci'on del pozo progresivo de las Tragamonedas}\req{req:ajuste_de_pozo_progresivo}
...
\item \negrita{El sistema es seguro} \req{req:sistema_seguro}
...
\item \negrita{El sistema permite suficientes jugadores} \req{req:suficientes_jugadores}
...
\item \negrita{Interfaz intuitiva y sencilla} \req{req:cool_GUI}
...
\item \negrita{Dise'no gr'afico atractivo} \req{req:graficos_buena_onda}

 Al igual que el anterior, fomentan el uso de los juegos.

\item \negrita{El sistema es eficaz} \req{req:sistema_eficaz}
