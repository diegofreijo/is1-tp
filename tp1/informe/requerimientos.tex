...
\item \negrita{El sistema permite la carga de los clientes con sus respectivos saldos} \req{req:carga_clientes}
...
\item \negrita{El sistema permite a los jugadores salir del casino} \req{req:egreso_del_casino}
...
\item \negrita{El sistema llevar'a registro de las mesas existentes} \req{req:registro_de_mesas}
...
\item \negrita{El sistema brinda valores de fichas preestablecidos para poder apostar} \req{req:apuesta_con_fichas}
...
\item \negrita{El sistema mantendr'a actualizado el saldo del ``pozo feliz''} \req{req:pozo_feliz_actualizado}

 El sistema se encargar'a de mantener actualizado el saldo del ``pozo feliz'' cuando se realicen jugadas ``feliz'' y ``todos ponen''.
 
\item \negrita{El sistema mantendr'a actualizado el saldo del ``pozo progresivo''} \req{req:pozo_progresivo_actualizado}
...
\item \negrita{El sistema persistir'a informaci'on de saldos de casino y jugadores como resultado de la resoluci'on de jugadas} \req{req:cuentas_claras}
...
\item \negrita{El sistema llevar'a registro detallado de apuestas y jugadas} \req{req:historial_clientes}
