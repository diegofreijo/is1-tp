...
\begin{description}
\item [Jugada] Para poder obtener los reportes de \italica{Ranking de jugadores} y \italica{Detalle de movimientos por jugador} es necesario guardar el historial de jugadas realizadas por cada jugador en la jornada. La clase jugada representa exactamente eso: una jugada realizada por alg'un jugador en alguna mesa en alg'un momento de la jornada del casino. Se especializa en el tipo de jugada correspondiente (Tragamonedas o Craps) y puede estar asociada a su resultado.
