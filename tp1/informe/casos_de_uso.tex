...
\op{7. Fin CU.}{}
\cu{Jugando a Craps}{Jugador}{-}{El jugador eligi'o una mesa de craps para jugar.}{-}
{En cualquier momento, el jugador podr'a chatear con los dem'as jugadores en la misma mesa. Tambi'en podr'a cancelar su apuesta, Ver FSM Craps sección \ref{FSMCraps} }
