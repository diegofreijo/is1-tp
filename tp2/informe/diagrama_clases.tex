...
\imagen{DC_DiagramaCompleto.png}{Diagrama de Clases}{0.18}
\clearpage
...
\item \italica{Clase AdministradorMesaTragamonedas} al igual que la anterior adminstra lo referente a las mesas y los tiros, pero en este caso es sobre el juego de Tragamonedas.
...
\item La \italica{Clase DespachadorRespuestas} es an'aloga a la anterior y tiene el mismo comportamiento diferenciadose en que es para las respuestas. Hay una por puerto.
