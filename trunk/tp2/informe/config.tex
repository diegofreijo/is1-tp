...
\usepackage{color}															% Permite agregarle color a la fuente
...
%%%%%%%%%%%%%%%% COMANDOS %%%%%%%%%%%%%%%%%%%%
\newcommand{\todo}[1]{{\textcolor{red}{\Huge\negrita{TODO: #1}}}}
...
\newcommand{\escenario}[2]{\textbf{Escenario para \textit{#1}}
...
\newcommand{\tam}{Dado el Tama~no de la imagen la imprimimos a parte o va en formato d\'igital}
