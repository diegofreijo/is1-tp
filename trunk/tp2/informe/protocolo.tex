...
\begin{verbatim}
    ...
    <respuestaReporteMovimientos vTerm="id terminal virtual">
       ...
       [<jugadores>
				...
				<tipoApuesta nombre="en sitio a perder | en sitio a ganar |de campo | venir | no venir | barra no pase | linea de pase | tragamonedas"/>
...
TodosPonen"/>
				<progresivo monto="adicional correspondiente al pago del pozo progresivo"(en caso de tragamonedas, si no el tag estará vacío)/>
			</jugadores>]
