...
\item\textit{Operaci'on reporte \italica{Ranking de jugadores}: }

\item\textit{Operaci'on reporte \italica{Estado actual}: }

\item\textit{Operaci'on reporte \italica{Detalle movimientos por jugador}: }
