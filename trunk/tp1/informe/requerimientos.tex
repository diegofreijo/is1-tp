...
\item \negrita{El sistema consta con juegos de tipo Tragamonedas } \req{req:existe_juego_tragamoneda}
...
\item \negrita{El sistema consta con juegos de tipo Craps} \req{req:existe_juego_craps}
