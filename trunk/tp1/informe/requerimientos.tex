...
\item \reqEsencial{req:creacion_ingreso_y_salida_de_mesa}\negrita{El sistema permite a los jugadores crear, ingresar y salir mesas de juego}
...
\begin{center}
    ...
    \hline
    \rrefEsencial{req:existe_juego_tragamoneda} & El sistema cuenta con juegos de tipo Tragamonedas conforme al reglamento proporcionado por los SOCIOS    &  Diagrama de Actividad  \ref{DA},  M'aquinas de estado \ref{FSM} , Modelo Conceptual \ref{MC} \\
    \hline
    \rrefEsencial{req:existe_juego_craps} & El sistema cuenta con juegos de tipo Craps conforme al reglamento proporcionado por los SOCIOS  &  Diagramas de Actividad \ref{DA}, M'aquinas de estado \ref{FSM}, Modelo Conceptual \ref{MC}  \\
    \hline
    ...
    \hline
    \rrefEsencial{req:apuesta_a_juegos} & El sistema permite a los jugadores apostar a los juegos & Casos de Uso \ref{CU}, Diagramas de Actividad \ref{DA} , Modelo Conceptual \ref{MC} \\
    \hline
    \rrefEsencial{req:saldos_actualizados} & El sistema actualizar'a el saldo del casino, jugadores y pozos especiales cuando se realicen apuestas y resuelvan jugadas, acorde a las reglas y modalidades acordadas &  Diagramas de Actividad \ref{DA}, Modelo Conceptual \ref{MC}  \\
    \hline
    ...
    \hline
    \rrefImportante{req:reportes} & El sistema llevar'a registro detallado de apuestas y jugadas y permitir'a generar reportes con informaci'on del estado del casino y sus jugadores& Casos de Uso \ref{CU}, Modelo Conceptual \ref{MC} \\
    \hline
    ...
    \hline
    \rrefDeseable{req:inv_mirar_y_salir_mesas} & El sistema permite a los invitados mirar una mesa de juego existente&  Casos de Uso \ref{CU}, Modelo Conceptual \ref{MC}  \\
    \hline
