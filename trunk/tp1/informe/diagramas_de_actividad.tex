...
Tambi'en puede verse la alteraci'on del flujo normal de resultados provocada por la activaci'on y uso del ``modo dirigido'' por parte del jefe de contabilidad (\rrefImportante{req:controlar_juegos}).
...
De la misma forma que en el diagrama anterior, aqu'i puede verse la alteraci'on del flujo provocada por el ``modo dirigido'' (\rrefImportante{req:controlar_juegos}).
