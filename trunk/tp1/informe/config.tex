...
% Tipos de requerimientos: esencial, importante, deseable y no funcional (puaj! no sé escribir un condicional en LaTeX así que uso distintos comandos :S)
\newcommand{\req}[1]{\italica{ \newcounter{#1}\setcounter{#1}{\arabic{reqsCounter}}\stepcounter{reqsCounter}Req \arabic{#1} }}
...
% \newcommand{\rref}[1]{\italica{req \arabic{#1}}}
