...
\op{3. Fin CU.}{}
\cu{Dejando de jugar en mesa}{Jugador}{-}{El jugador esta jugando en una mesa y puede salir (ver FSM \ref{FSM})}{El jugador no est'a jugador esta en el lobby (no esta jugando en ninguna mesa)}{Si es el último jugador en la mesa el sistema cierra la mesa}{\rrefEsencial{req:auto_cerrar_mesas}}
