	...
	class AccesoYVistaCraps
	{
		...
		public void EntrarCraps(XElement parametros)
		{
			try
			{
				...
				Vista.Vistas.AccesoYVistaCraps.ObtenerInstancia().ResponderEntradaCraps(id_terminal, usuario, id_mesa, true, "Bienvenido a la mesa!");
			}
			catch (Exception ex)
			{
		...
		public void SalirCraps(XElement parametros)
		{
			try
			{
				...
				// Envio la respuesta satisfactoria
				Vista.Vistas.AccesoYVistaCraps.ObtenerInstancia().ResponderEntradaCraps(id_terminal, usuario, id_mesa, true, "Gracias por gastar plata en esta mesa!");
			}
			catch (Exception ex)
			{
