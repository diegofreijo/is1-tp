...
\subsubsection{Desici'ones y acciones efectuadas en la decisi'on de un tipo de jugada}
...
\imagen{DA_TipoDeJugada}{Desici'ones y acciones efectuadas en la decisi'on de un tipo de jugada}{0.5}
