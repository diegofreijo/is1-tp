...
\op{1 operacion 1}{la otra}
\op{2 operacion 2}{}
\op{3 operacion 3}{3.1 si falla aca, cagamos }

\cu {Nombre del Caso} {El Actor Primario} {El Actor Secundario} {La Precondicion } {La Poscondicion}
