...
{
	public class Venir : ApuestaCraps
	{

		private Entero puntaje_venir;

		/// 
		/// <param name="fichas"></param>
		/// <param name="apostador"></param>
		/// <param name="estado"></param>
		public Venir(Diccionario<Creditos, Entero> fichas, Jugador apostador, EstadoApuestaCraps estado)
		{
