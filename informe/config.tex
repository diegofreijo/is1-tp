...
% \hline
 \multicolumn{2}{l}{Caso de Uso:\begin{large}\italica{\negrita{#1}}\end{large}}\\ 
% \multicolumn{2}{l}{ Caso de Uso: #1}\\ 
\hline
\multicolumn{2}{|l|}{Actor Primario:\negrita{#2}}\\
\hline
\multicolumn{2}{|l|}{Actor Secundario:\negrita{#3}}\\
\hline
\multicolumn{2}{|l|}{Precondici'on:\negrita{#4}}\\
\hline
\multicolumn{2}{|l|}{Postcondici'on: \negrita{#5}}\\
% \hline
% \multicolumn{2}{l}{}\\
\hline
