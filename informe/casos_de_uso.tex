...
%%%%%%%%%%%%% NUEVA FORMA DE ESCRIBIR CASOS DE USO
 \op{1 El sistema le pregunta al jugador si quiere jugar a tragamonedas o a craps.}{ }
 \op{2 El jugador elige el tipo de juego al que desea jugar.}{ }
 \op{3 Si elige jugar al tragamonedas, EXTIENDE ``Creando mesa'' e IR A PASO \ref{label_jugar}. Si no, el sistema le pregunta si desea unirse a una mesa existente o crear una nueva.}{ }
\op{4 Si elige unirse a una mesa, EXTIENDE ``Eligiendo mesa''. Si en cambio elige crear una mesa, EXTIENDE ``Creando mesa''.}{ }
\op{5 Si eligi'o jugar a Craps, EXTIENDE ``Jugando a Craps''. Si en cambio eligi'o jugar a Tragamonedas, EXTIENDE ``Jugando a Tragamonedas''.\label{label_jugar}}{ }
\op{6 Fin CU.}{6.1 aca iria el alternativo }
\cu {Jugando en una mesa} {Jugador} {} {el esta logueado } { el jugardor esta }
...
% --------------- Eligiendo mesa ---------------------
\op{1. El sistema le muestra al eligidor de mesa las mesas de craps abiertas}{}
\op{2. El eligidor de mesa elige una mesa}{}
\op{3. Fin CU}{}
\cu{CU: Eligiendo mesa}{Jugador}{-}{-}{El jugador tiene como 'unica mesa elegida para jugar a la mesa seleccionada.}
